...
const baseInputStyles = "mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm";
...
export default function GalleryForm({ initialData, onSubmit }: GalleryFormProps) {
  const [formData, setFormData] = useState<GalleryDocument>(initialData ? { ...initialFormState, ...initialData } : initialFormState);
